...
function kenta_customize_register( $wp_customize ) {
	...
	if ( ! kenta_apply_filters( 'should_reload_customizer_settings', ( $wp_customize || ! CZ::checked( 'kenta_enable_customizer_cache' ) || kenta_get_theme_version() !== $settings_version ) ) ) {
